 ...
 @section('mainContent')    
                ...
                <div class="vehicle">
                    ...
                    <div class="vehicle_rego">
                                ...
                                <a href="{{ url("updateClient/$client->Client_id") }}" class="btn btn-primary" role="button">Edit</a>
                                <a href="{{ url("viewClient/$client->Client_id") }}" class="btn btn-primary" role="button">View</a>
                    </div>
                </div>
                @endforeach
